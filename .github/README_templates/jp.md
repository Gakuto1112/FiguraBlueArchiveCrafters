...
![バリエーションコスチューム](../README_images/alt_costume.jpg)
...
[アクションホイールのアクション4](#アクション4-一人称視点での武器モデルの表示の切り替え)からアバター設定ページに移動できます。

![アバター設定アクションホイール](../README_images/action_config.jpg)
