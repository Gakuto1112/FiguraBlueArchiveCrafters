        ...
        events.TICK:register(function ()
            if not client:isPaused() then
                ...
                if ExSkill.animationCount == -1 then
                    ...
                    local hasChargedCrossbow = (heldItems[1].id == "minecraft:crossbow" and ((gameVersion >= "1.20.5" and #heldItems[1].tag["minecraft:charged_projectiles"] >= 1) or (gameVersion < "1.20.5" and heldItems[1].tag.Charged == 1)) and Gun.currentGunPosition == "RIGHT") or (heldItems[2].id == "minecraft:crossbow" and ((gameVersion >= "1.20.5" and #heldItems[2].tag["minecraft:charged_projectiles"] >= 1) or (gameVersion < "1.20.5" and heldItems[2].tag.Charged == 1)) and Gun.currentGunPosition == "LEFT")
