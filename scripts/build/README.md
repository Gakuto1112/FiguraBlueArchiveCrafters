...
| --- | --- | --- |
| explosive | Explosive (Red) | ![Example of a red thumbnail](./docs/readme_images/thumbnail_examples/explosive.png) |
| penetration | Penetration (Yellow) | ![Example of a yellow thumbnail](./docs/readme_images/thumbnail_examples/penetration.png) |
| chemical | Chemical (Green) | ![Example of a green thumbnail](./docs/readme_images/thumbnail_examples/chemical.png) |
| mystic | Mystic (Blue) | ![Example of a blue thumbnail](./docs/readme_images/thumbnail_examples/mystic.png) |
| sonic | Sonic (Purple) | ![Example of a purple thumbnail](./docs/readme_images/thumbnail_examples/sonic.png) |
...
3. Generate thumbnails
   ...
   Based on [`/thumbnail_templates/`](../../thumbnail_templates/), inserts specific data from [`thumbnail_config.json`](#thumbnail_configjson) and `thumbnail.png` to generate thumbnail images.
