...
---@field public new fun(parent: Avatar, pos: Vector2, velocity: Vector2, type: FrameParticle.ParticleType): ExSkillFrameParticle コンストラクタ
...
FrameParticle = {
    ...
    spawn = function (particleUUID, screenPos, type, velocity)
        ...
        instance.tick = function (self)
            ...
            self.object:setScale(vectors.vec3(1, 1, 1):scale(1 - self.counter / 5))
        ...
        instance.render = function (self, delta)
            ...
            self.object:setScale(vectors.vec3(1, 1, 1):scale(1 - (self.counter + delta) / 5))
        end
