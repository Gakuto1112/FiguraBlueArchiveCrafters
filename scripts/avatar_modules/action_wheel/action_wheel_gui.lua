        ...
        if host:isHost() then
            events.TICK:register(function ()
                ...
                if isActionWheelOpened and not self.isActionWheelOpenedPrev then
                    ...
                    --models.models.action_wheel_gui.Gui.ExSkillGuide:getTask("action_wheel.gui.ex_skill_guide.body"):setText(self.parent.characterData.costume.costumes[self.parent.costume.currentCostume].subExSkill ~= nil and "§0§l\""..self.parent.locale:getLocale("action_wheel_gui.ex_skill_guide.ex_skill_"..self.parent.characterData.costume.costumes[self.parent.costume.currentCostume].exSkill..".name").."\"§r\n§0"..self.parent.locale:getLocale("action_wheel_gui.ex_skill_guide.key_pre")..self.parent.keyManager.keyMappings.ex_skill:getKeyName()..self.parent.locale:getLocale("action_wheel_gui.ex_skill_guide.key_post") or "§0§l\""..self.parent.locale:getLocale("action_wheel_gui.ex_skill_guide.ex_skill_"..self.parent.characterData.costume.costumes[self.parent.costume.currentCostume].exSkill..".name").."\"§r§0 - \""..self.parent.keyManager.keyMappings.ex_skill:getKeyName().."\"\n§l\""..self.parent.locale:getLocale("action_wheel_gui.ex_skill_guide.ex_skill_"..self.parent.characterData.costume.costumes[self.parent.costume.currentCostume].subExSkill..".name").."\"§r§0 - \""..self.parent.keyManager.keyMappings.ex_skill_sub:getKeyName().."\"")
