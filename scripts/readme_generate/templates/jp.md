...
- 上記以外にも、特定の生徒のみで利用可能な機能があります。
  ...
  | ケイ | - Exスキル再生後に増幅装置をその場に残します。まれにビーコンを残すこともあるみたいです。 |
  | ミカ（通常） | - Exスキル再生後に目の前に隕石を落とします（視覚的な演出のみ）。 |
  | ミカ（水着） | - 水に浸かると濡れます。その姿は夜空に浮かぶ星々のよう...<br> - Exスキル再生後に流れ星のシャワーを降らせます。 |
  | ナツ | - パイを投げます。パイは近くのプレイヤーに飛んでいき、さらに投擲されたパイを中心として周囲にまだパイを受け取っていない自身を除くプレイヤーがいる場合、パイがその方向にも飛んでいきます。（最大4回まで） <br> 攻撃力は上がりません。ただただ美味しいだけです。 |
